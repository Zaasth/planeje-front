            ...
            <form>
                <div className="space-y-12">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="mt-2 border-2 rounded-lg border-2 rounded-lg">
                            <textarea
                            id="about"
                            name="about"
                            rows={3}
                        ...
                        <div className="mt-2 border-2 rounded-lg flex items-center gap-x-3">
                        ...
                        <div className="mt-2 border-2 rounded-lg flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="mt-2 border-2 rounded-lg grid grid-cols-1">
                            <select
                            id="country"
                            name="country"
